...
export default function CreateAlertModal({ isOpen, onClose, userLocation }: CreateAlertProps) {
    ...
    return (
        <div className="fixed inset-0 z-[2030] flex items-center justify-center p-4 bg-background/80 backdrop-blur-sm">
            <div className="glass-card max-w-lg w-full p-6 border-border shadow-2xl relative animate-in fade-in zoom-in-95 duration-200 max-h-[85vh] overflow-y-auto custom-scrollbar">
