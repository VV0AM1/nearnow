...
export default function Sidebar({ initialUser }: SidebarProps) {
    ...
    return (
        <aside className={`hidden lg:flex flex-col transition-all duration-300 relative z-40 ${styles.sidebarContainer}`}>
            <div className={`flex flex-col h-full rounded-2xl overflow-hidden ${styles.glassDock} ${isOpen ? styles.widthExpanded : styles.widthCollapsed}`}>
                {/* Header / Toggle */}
